...
Подождите, [[pair|pair]] и [[tuple (Кортежи)|tuple]] - это не волшебство (просто их почти невозможно записать в STL-качестве), могут ли мои типы работать с этим?
...
# Deduction Guides
Кстати, о [[pair|pair]] и [[tuple (Кортежи)|кортеже tuple]].
### C++14
```c++
