...
Подробнее этот вопрос рассматривается в #разделе_15_10_2.
...
[[decltуре|decltype]] может определять как категорию значения, так и тип данного выражения. Как показано в #разделе_15_10_2, для описания ситуаций, когда выражение является `l-` или `х-значением`, используются ссылочные типы:
```c++
