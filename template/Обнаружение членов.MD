...
К сожалению, в настоящее время это можно сделать только с помощью макросов, поскольку не существует механизма для описания “потенциального” имени. Лучшее, что мы можем получить в данный момент без использования макросов, — применение [[Обнаружение членов#Использование обобщенных лямбда-выражений для обнаружения членов|обобщенных лямбда-выражений]].
