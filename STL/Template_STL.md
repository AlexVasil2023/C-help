...
Аргументы-значения полезны во многих контекстах. Например, `Buffer` позволяет нам
создавать буферы произвольного размера без использования динамической памяти:
