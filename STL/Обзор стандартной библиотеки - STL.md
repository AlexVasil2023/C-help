...
> 
> Потоки ввода-вывода - это расширяемая платформа для ввода и вывода, в которую пользователи могут добавлять свои собственные типы, потоки, стратегии буферизации, локали и наборы символов ( #глава_11). Он также предлагает средства для гибкого [[format#Форматирование в стиле printf()|форматирования выходных данных]].
> 
