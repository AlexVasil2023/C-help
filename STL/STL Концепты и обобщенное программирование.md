...
Диапазон - это концепция стандартной библиотеки, представляющая последовательность с [[begin|begin()]] и [[end|end()]]. Для полной обобщённости мы также можем абстрагировать операцию `+=`; см. #§17_3.
