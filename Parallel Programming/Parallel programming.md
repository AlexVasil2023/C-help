...
7. [[#Будущее языка C++|Будущее языка C++]]
	1. [[#Исполнители|Исполнители]]
	2. [[#Расширенные фьючерсы|Расширенные фьючерсы]]
	3. [[#Транзакционная память|Транзакционная память]]
	4. [[#Блоки заданий|Блоки заданий]]
	5. [[#Библиотека для векторных вычислений|Библиотека для векторных вычислений]]
...
10. [[#Сложности параллельного программирования|Сложности параллельного программирования]]
11. [[#Библиотека для работы со временем|Библиотека для работы со временем]]
12. [[#Обзор инструментального средства CppMem|Обзор инструментального средства CppMem]]
